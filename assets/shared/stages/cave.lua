function onCreate()
	...
	makeLuaSprite('stages/secret-shhhh/faker/cave_left', 'stages/secret-shhhh/faker/cave_left', -600, -300);
	setScrollFactor('stages/secret-shhhh/faker/cave_left', 1.0, 1.0);
	...
	addLuaSprite('stages/secret-shhhh/faker/cave_left', false);
