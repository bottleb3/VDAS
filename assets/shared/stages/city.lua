function onCreate()
-- background shit
makeLuaSprite('layer1', 'stages/canon/freeplay/city', -900, -300);
setScrollFactor('layer1', 0.8, 0.8);
makeLuaSprite('layer2', 'stages/canon/freeplay/city', -600, -300);
setScrollFactor('layer2', 1.0, 1.0);
makeAnimatedLuaSprite('layer3', 'backgroundcharacters/citypersons', -600, -300);
