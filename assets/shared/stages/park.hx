...
{
	FlxG.mouse.load(Paths.image("cursor").bitmap, 0.5, 32, 32);
	FlxG.mouse.visible = true;
	if (ClientPrefs.data.secretlock >= 0) close(true);
}
function onDestroy()
{
...
{
    var onhover:Bool = FlxG.mouse.overlaps(nsh);
