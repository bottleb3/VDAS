function onCreate()
	...
	luaSpriteAddAnimationByPrefix('stages/funlearn/school_hallwaychase', 'stages/funlearn/school_hallwaychase', 'stages/funlearn/school_hallwaychase idle', 24, true);
