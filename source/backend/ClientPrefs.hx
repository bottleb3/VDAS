...
@:structInit class SaveVariables {
	...
	public var secretlock(default, set):Int = -1; // -1:none 0:1st song 1:1st and 2nd song 2:1st and 2nd and 3rd 3:all songs
	...
	private function set_secretlock(v:Float) { //Everytime the lock changes, it puts into ts range
		return secretlock = Std.int(FlxMath.bound(v, -1, 3));
	}
}
