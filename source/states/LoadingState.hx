...
class LoadingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var lim:Array<String> = MainMenuState.getMImages("loading_screen/loading");
		var key:String = "loading_screen/loading/"+ lim[FlxG.random.int(0, lim.length-1)];

		funkay = new FlxSprite(0, 0).loadGraphic(Paths.image(key));
